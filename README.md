...
```javascript
import gdot from 'https://cdn.jsdelivr.net/gh/stdlib-js/blas-base-gdot@v0.0.8-deno/mod.js';
```

You can also import the following named exports from the package:

```javascript
import { ndarray } from 'https://cdn.jsdelivr.net/gh/stdlib-js/blas-base-gdot@v0.0.8-deno/mod.js';
```
